...
var AutoCompleteAjax = function (options) {
    var query = options.query, onSelect = options.onSelect, keyString = options.keyString, initialText = options.initialText, placeholder = options.placeholder, customRender = options.customRender;
